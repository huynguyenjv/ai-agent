"""GitLab API client for server-side code review flow.

Extracted from mcp_server/tools_review.py to decouple server/ from mcp_server/
(MCP runs on user's machine; server runs on cloud — separate deployments).
"""
...
logger = logging.getLogger("server.gitlab")
